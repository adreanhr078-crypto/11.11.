---
name: 11-11-puzzles
description: Create, review, fix, or extend any 11.11 puzzle surface: puzzle data, puzzle types, PuzzleScreen, story-puzzles, puzzle-hub, Fragment Law canon, puzzle achievement linkage, or puzzle accessibility. Use before authoring new puzzles or changing puzzle behavior; enforce story-reveal canon and accessible completion moments. Do not modify frozen systems (achievements, endings, cinematics) unless the task explicitly scopes puzzle-only changes within allowed boundaries.
---
