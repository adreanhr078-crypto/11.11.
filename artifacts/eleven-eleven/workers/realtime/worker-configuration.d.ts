/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/realtime/wrangler.jsonc workers/realtime/worker-configuration.d.ts` (hash: 2f2f248f6e5bf33dbfd8eecdc2e52cee)
// Runtime types generated with workerd@1.20260804.1 2026-08-11 nodejs_compat
interface __BaseEnv_Env {
	REPLAYS: R2Bucket;
	PLAYER_DB: D1Database;
	NETWORK_ANALYTICS: AnalyticsEngineDataset;
	RESULT_QUEUE: Queue;
	REALTIME_ALLOWED_ORIGINS: "http://localhost:3000,http://127.0.0.1:3000,http://localhost:5173,http://127.0.0.1:5173";
	MATCHMAKER_ROOMS: DurableObjectNamespace<import("./src/index").MatchmakerRoom>;
	CHESS_MATCH_ROOMS: DurableObjectNamespace<import("./src/index").ChessMatchRoom>;
	COOP_SESSION_ROOMS: DurableObjectNamespace<import("./src/index").CoopSessionRoom>;
	PARTY_ROOMS: DurableObjectNamespace<import("./src/index").PartyRoom>;
	COMMUNITY_CHANNEL_ROOMS: DurableObjectNamespace<import("./src/index").CommunityChannelRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MatchmakerRoom" | "ChessMatchRoom" | "CoopSessionRoom" | "PartyRoom" | "CommunityChannelRoom";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REALTIME_ALLOWED_ORIGINS">> {}
}
