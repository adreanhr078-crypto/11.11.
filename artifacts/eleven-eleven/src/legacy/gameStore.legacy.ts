/**
 * @deprecated Preserved Phase 1 snapshot of the pre-refactor God Store.
 * The active state layer is src/stores/gameStore.ts.
 *
...
import type {
  ...
  DailyMission, CoinShopPrices, MissionType, EntityId
} from '../core/gameTypes';
