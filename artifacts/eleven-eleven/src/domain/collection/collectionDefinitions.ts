...
export const PHASE5_ACHIEVEMENT_DEFINITIONS: readonly CollectionAchievementDefinition[] = Object.freeze([
  ...
  { id: 'mastery_no_hint_five', name: 'NOISELESS HAND', description: 'Complete five verified Puzzles without hints.', category: 'mastery', hidden: false, presentationTier: 'rare', icon: 'mastery', condition: { kind: 'no-hint-solves', target: 5 }, reward: noEconomyReward() },
