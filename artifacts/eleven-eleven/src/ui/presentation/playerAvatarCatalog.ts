...
export const PLAYER_AVATAR_CATALOG: readonly PlayerAvatarCatalogEntry[] = [
  ...
  },
  {
    id: 'silver_signal',
    label: 'Silver Signal',
    src: '/assets/avatars/player-silver-v1.webp',
    presentationSrc: '/assets/avatars/player-silver-v1.webp',
    availability: 'starter',
    rarity: 'standard',
  },
  {
    id: 'red_rift',
    label: 'Red Rift',
    src: '/assets/avatars/player-rift-v1.webp',
    presentationSrc: '/assets/avatars/player-rift-v1.webp',
    availability: 'starter',
    rarity: 'standard',
  },
  {
